...
$root.server_interface = (function() {
    ...
    server_interface.Chart = (function() {
        ...
        Chart.encode = function encode(message, writer) {
            ...
            if (message.sendPacketCount != null && Object.hasOwnProperty.call(message, "sendPacketCount"))
        ...
        Chart.verify = function verify(message) {
            ...
            if (message.sendPacketCount != null && message.hasOwnProperty("sendPacketCount"))
                if (!$util.isInteger(message.sendPacketCount))
                    return "sendPacketCount: integer expected";
            if (message.receivePacketCount != null && message.hasOwnProperty("receivePacketCount"))
    ...
    server_interface.Charts = (function() {
            ...
            while (reader.pos < end) {
                ...
                case 3:
                    if (!(message.ticks && message.ticks.length))
                        message.ticks = [];
                    message.ticks.push($root.server_interface.Chart.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    server_interface.RoundTick = (function() {
        ...
        RoundTick.encode = function encode(message, writer) {
            ...
            if (message.receivePacketCount != null && Object.hasOwnProperty.call(message, "receivePacketCount"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.receivePacketCount);
            if (message.sendPacketBytes != null && Object.hasOwnProperty.call(message, "sendPacketBytes"))
    ...
    server_interface.Problem = (function() {
    ...
    server_interface.Event = (function() {
    ...
    server_interface.Events = (function() {
            ...
            while (reader.pos < end) {
                ...
                case 2:
                    if (!(message.events && message.events.length))
                        message.events = [];
                    message.events.push($root.server_interface.Event.decode(reader, reader.uint32()));
                    break;
                case 3:
                    message.success = reader.bool();
                    break;
